...
if __name__ == '__main__':
    import argparse
    parser = argparse.ArgumentParser(description='Myriota device manager authentication CLI')
    parser.add_argument("-c", "--clear", action='store_true', help="Clear temporary token and login with username and password.")
